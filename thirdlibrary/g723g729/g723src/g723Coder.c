...
**
*/
_declspec(dllexport) void  Init_Coder( void)
{
    int   i ;
...
**
*/
_declspec(dllexport) Flag  Coder( Word16 *DataBuff, char *Vout )
{
    int     i,j   ;
    ...
    */
    ...
    if(Ftyp != 1) {
        ...
        */
        ...
        /*
        // Start the g723sub frame processing loop
        */
        Dpnt = DataBuff ;
        ...
        for ( i = 0 ; i < SubFrames ; i ++ ) {
            ...
            /* Subtract the ringing of previous g723sub-frame */
            ...
            for ( j = 0 ; j < SubFrLen ; j ++ ) {
                ...
                Dpnt[j] = g723add( Dpnt[j], ImpResp[j] ) ;
