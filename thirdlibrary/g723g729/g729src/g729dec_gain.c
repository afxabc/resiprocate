...
)
{
   ...
   if(bfi != 0){
      *gain_pit = g729mult( *gain_pit, 29491 );      /* *0.9 in Q15 */
      if (g729sub( *gain_pit, 29491) > 0) *gain_pit = 29491;
      *gain_cod = g729mult( *gain_cod, 32111 );      /* *0.98 in Q15 */
   ...
   index1 = imap1[ g729shr(index,NCODE2_B) ] ;
   index2 = imap2[ index & (NCODE2-1) ] ;
   *gain_pit = g729add( gbk1[index1][0], gbk2[index2][0] );
