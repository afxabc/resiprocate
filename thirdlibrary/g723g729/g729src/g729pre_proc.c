...
_declspec(dllexport) void Init_Pre_Process(void)
{
  y2_hi = 0;
  y2_lo = 0;
  y1_hi = 0;
...
_declspec(dllexport) void Pre_Process(
  ...
  Word16 lg)          /* length of signal    */
{
  ...
  for(i=0; i<lg; i++)
  {
     ...
     L_tmp     = g729L_add(L_tmp, Mpy_32_16(y2_hi, y2_lo, a140[2]));
     L_tmp     = g729L_mac(L_tmp, x0, b140[0]);
     L_tmp     = g729L_mac(L_tmp, x1, b140[1]);
     L_tmp     = g729L_mac(L_tmp, x2, b140[2]);
     L_tmp     = g729L_shl(L_tmp, 3);      /* Q28 --> Q31 (Q12 --> Q15) */
     signal[i] = g729round(L_tmp);
