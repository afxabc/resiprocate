...
class _declspec(dllexport) SipUserAgent
{
public:
	SipUserAgent();
	...
	virtual void OnIncomingCall(std::string sCallId, std::string sDisplayName, std::string sUserName, std::string sFromURI, std::string sToURI) {};
